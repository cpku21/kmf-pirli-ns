...
export default function HeroSection({ nextMatch }: HeroSectionProps) {
  ...
  return (
    <div
      ...
      className="w-full bg-[#111827] border-b border-slate-800/80 py-4 px-4 font-sans mt-14"
    >
      {/* mt-14 zbog fiksnog header-a */}
      <div className="max-w-md mx-auto space-y-4">
        {/* Sledeća Utakmica Card */}
        <div className="bg-gradient-to-br from-[#1F2937]/90 to-[#111827]/95 border border-slate-700/60 rounded-2xl p-5 shadow-lg relative overflow-hidden backdrop-blur-sm">
          ...
          <div className="grid grid-cols-7 items-center text-center py-1">
            ...
            <div className="col-span-1 flex flex-col items-center justify-center select-none">
              <div className="w-6 h-6 rounded-full bg-[#0B1220] border border-slate-700/50 flex items-center justify-center shadow">
                <span className="text-[8px] font-black font-mono text-blue-400">
                  VS
                </span>
              </div>
            </div>
            ...
            <div className="col-span-3 flex flex-col items-center gap-1.5 min-w-0">
              ...
              <span
                className="text-xs font-extrabold text-slate-200 uppercase tracking-wider truncate w-full px-1"
                title={opponent}
              >
                {opponent}
              </span>
          ...
          <div className="mt-4 pt-3.5 border-t border-slate-800/80 grid grid-cols-2 gap-2 text-[9px] text-slate-400 font-mono font-bold uppercase tracking-wider">
            <div className="flex items-center gap-1.5 bg-[#0B1220]/60 px-2 py-1.5 rounded border border-slate-800/40">
              ...
              <span className="truncate">
                {matchDateFormatted} • {matchTimeFormatted}h
              </span>
            </div>
            <div className="flex items-center gap-1.5 bg-[#0B1220]/60 px-2 py-1.5 rounded border border-slate-800/40">
        ...
        <div className="grid grid-cols-4 gap-2 pt-1">
          ...
          >
            <Calendar
              size={16}
              className="text-blue-500 mb-1 group-hover:scale-110 transition-transform duration-150"
            />
            <span className="text-[8px] font-bold text-slate-400 font-mono uppercase tracking-wider text-center">
              Utakmice
            </span>
          </Link>
          ...
          >
            <Trophy
              size={16}
              className="text-yellow-500 mb-1 group-hover:scale-110 transition-transform duration-150"
            />
            <span className="text-[8px] font-bold text-slate-400 font-mono uppercase tracking-wider text-center">
              Tabela
            </span>
          ...
          >
            <Users
              size={16}
              className="text-emerald-500 mb-1 group-hover:scale-110 transition-transform duration-150"
            />
            <span className="text-[8px] font-bold text-slate-400 font-mono uppercase tracking-wider text-center">
              Igrači
            </span>
          ...
          >
            ...
            <Tv
              size={16}
              className="text-purple-500 mb-1 group-hover:scale-110 transition-transform duration-150"
            />
            <span className="text-[8px] font-bold text-slate-400 font-mono uppercase tracking-wider text-center">
              Uživo
            </span>
          ...
          >
            <BarChart3
              size={16}
              className="text-amber-500 mb-1 group-hover:scale-110 transition-transform duration-150"
            />
            <span className="text-[8px] font-bold text-slate-400 font-mono uppercase tracking-wider text-center">
              Statistika
            </span>
          ...
          >
            <History
              size={16}
              className="text-indigo-400 mb-1 group-hover:scale-110 transition-transform duration-150"
            />
            <span className="text-[8px] font-bold text-slate-400 font-mono uppercase tracking-wider text-center">
              Istorija
            </span>
          ...
          >
            <ImageIcon
              size={16}
              className="text-teal-400 mb-1 group-hover:scale-110 transition-transform duration-150"
            />
            <span className="text-[8px] font-bold text-slate-400 font-mono uppercase tracking-wider text-center">
              Galerija
            </span>
          ...
          >
            <Settings
              size={16}
              className="text-slate-400 mb-1 group-hover:rotate-45 transition-transform duration-350"
            />
            <span className="text-[8px] font-bold text-slate-400 font-mono uppercase tracking-wider text-center">
              Admin
            </span>
